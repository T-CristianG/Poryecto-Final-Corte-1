...
if "%PHPBIN%" == "" set PHPBIN=C:\Users\Cristian\Documents\Java\Programacion Avanzada\Corte 1\Proyecto-Programacion\Poryecto-Final-Corte-1\ChicasMagicas\Base-De-Datos\php\.\php.exe
if not exist "%PHPBIN%" if "%PHP_PEAR_PHP_BIN%" neq "" goto USE_PEAR_PATH
GOTO RUN
:USE_PEAR_PATH
set PHPBIN=%PHP_PEAR_PHP_BIN%
:RUN
"%PHPBIN%" "C:\Users\Cristian\Documents\Java\Programacion Avanzada\Corte 1\Proyecto-Programacion\Poryecto-Final-Corte-1\ChicasMagicas\Base-De-Datos\php\phpunit" %*
